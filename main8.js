...
let para = "Mi Princesita Eteichiii"; // valor por defecto
let mensaje = `Mi vida hay tantas cosas bonitas en este mundo que quiero decirte porque sin duda tú mereces todo lo bonito del mundo🥹
Estuve pensando qué hice para tener una persona tan linda como tú.
cada vez que me llega un mensaje tuyo me pone muy feliz aunque hablemos poco todo el día, tus mensajes me  ponen tan feliz que por poco lloro por alegría eres y será siempre mi persona favorita, 
me gusta todo de ti , eres una persona maravillosa increíble y no quiero que dejes que alguien te diga lo contrario.❤️🥰🥹Gracias por hacerme la persona más feliz del mundo no sé cómo describir lo que siento por ti, 
un simple te amo no es suficiente en serio mi amor te agradezco por todo. 
...
let loadingText = "Para ti mi steyci"; // valor por defecto para loading
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  if (params.loading) {
    ...
    loadingText = "Para Mi Princesa Hermosa Steyci";
  }
